(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/tooltip'), require('prop-types'), require('@nivo/colors'), require('lodash/get'), require('lodash/isFunction'), require('d3-format'), require('d3-geo'), require('@nivo/legends')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/tooltip', 'prop-types', '@nivo/colors', 'lodash/get', 'lodash/isFunction', 'd3-format', 'd3-geo', '@nivo/legends'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.PropTypes, global.nivo, global['lodash/get'], global['lodash/isFunction'], global.d3, global.d3, global.nivo));
}(this, (function (exports, React, core, tooltip, PropTypes, colors, _get, _isFunction, d3Format, d3Geo, legends) { 'use strict';
