(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('prop-types'), require('@nivo/colors'), require('@nivo/annotations'), require('d3-shape'), require('d3-scale'), require('@nivo/tooltip'), require('react-spring')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', 'prop-types', '@nivo/colors', '@nivo/annotations', 'd3-shape', 'd3-scale', '@nivo/tooltip', 'react-spring'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global.nivo, global.nivo, global.d3, global.d3, global.nivo, global['react-spring']));
}(this, (function (exports, React, core, PropTypes, colors, annotations, d3Shape, d3Scale, tooltip, reactSpring) { 'use strict';
  ...
  var FunnelPropTypes = _objectSpread2({
    ...
    labelColor: colors.inheritedColorPropType.isRequired,
  ...
  var FunnelDefaultProps = {
    ...
    role: 'img',
    animate: core.MotionConfigProvider.defaultProps.animate,
    motionConfig: core.MotionConfigProvider.defaultProps.config
  };
  ...
  var computeShapeGenerators = function computeShapeGenerators(interpolation, direction) {
    ...
    return [areaGenerator, d3Shape.line().defined(function (d) {
      return d !== null;
    }).x(function (d) {
      return d.x;
    }).y(function (d) {
  ...
  var useFunnel = function useFunnel(_ref4) {
    var data = _ref4.data,
        ...
        colors$1 = _ref4$colors === void 0 ? FunnelDefaultProps.colors : _ref4$colors,
    ...
    var getLabelColor = colors.useInheritedColor(labelColor, theme);
  ...
  var useFunnelAnnotations = function useFunnelAnnotations(parts, annotations$1) {
  ...
  var FunnelAnnotations = function FunnelAnnotations(_ref) {
    var parts = _ref.parts,
        ...
        width = _ref.width,
        height = _ref.height;
    var boundAnnotations = useFunnelAnnotations(parts, annotations$1);
  ...
  var WrappedFunnel = core.withContainer(Funnel);
