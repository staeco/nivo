(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/sortBy'), require('lodash/cloneDeep'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withProps'), require('recompose/pure'), require('d3-hierarchy'), require('d3-shape'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/tooltip')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/sortBy', 'lodash/cloneDeep', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withProps', 'recompose/pure', 'd3-hierarchy', 'd3-shape', '@nivo/core', '@nivo/colors', '@nivo/tooltip'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/sortBy'], global['lodash/cloneDeep'], global.RecomposeCompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposeWithProps, global.RecomposePure, global.d3, global.d3, global.nivo, global.nivo, global.nivo));
}(this, (function (exports, React, PropTypes, sortBy, cloneDeep, compose, defaultProps, withPropsOnChange, withProps, pure, d3Hierarchy, d3Shape, core, colors, tooltip) { 'use strict';
