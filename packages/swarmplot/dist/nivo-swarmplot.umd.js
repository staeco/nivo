(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/axes'), require('@nivo/voronoi'), require('prop-types'), require('@nivo/scales'), require('@nivo/annotations'), require('lodash/get'), require('@nivo/tooltip'), require('lodash/isString'), require('lodash/isNumber'), require('lodash/isPlainObject'), require('d3-scale'), require('d3-force'), require('react-motion')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/axes', '@nivo/voronoi', 'prop-types', '@nivo/scales', '@nivo/annotations', 'lodash/get', '@nivo/tooltip', 'lodash/isString', 'lodash/isNumber', 'lodash/isPlainObject', 'd3-scale', 'd3-force', 'react-motion'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.nivo, global.PropTypes, global.nivo, global.nivo, global['lodash/get'], global.nivo, global['lodash/isString'], global['lodash/isNumber'], global['lodash/isPlainObject'], global.d3, global.d3, global.ReactMotion));
}(this, (function (exports, React, core, colors, axes, voronoi, PropTypes, scales, annotations, get, tooltip, isString, isNumber, isPlainObject, d3Scale, d3Force, reactMotion) { 'use strict';
...
//# sourceMappingURL=nivo-swarmplot.umd.js.map
