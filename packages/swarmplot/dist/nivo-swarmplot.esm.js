...
import { motionPropTypes, useValueFormatter, withContainer, useDimensions, useTheme, SvgWrapper, ResponsiveWrapper, getRelativeCursor, isCursorInRect } from '@nivo/core';
import { ordinalColorsPropType, colorPropertyAccessorPropType, inheritedColorPropType, useOrdinalColorScale, interpolateColor, getInterpolatedColor, useInheritedColor } from '@nivo/colors';
import { axisPropType, Grid, Axes, renderGridLinesToCanvas, renderAxesToCanvas } from '@nivo/axes';
import { Mesh, useVoronoiMesh, renderVoronoiToCanvas, renderVoronoiCellToCanvas } from '@nivo/voronoi';
import PropTypes from 'prop-types';
import { scalePropType, computeScale } from '@nivo/scales';
import { annotationSpecPropType, useAnnotations, Annotation, useComputedAnnotations, renderAnnotationsToCanvas } from '@nivo/annotations';
...
var SwarmPlotPropTypes = _objectSpread({}, commonPropTypes, motionPropTypes);
...
var computeValueScale = function computeValueScale(_ref) {
  ...
  return computeScale(_objectSpread$1({}, scale, {
    axis: axis
...
var ResponsiveSwarmPlot = function ResponsiveSwarmPlot(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(SwarmPlot$1, _extends$1({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveSwarmPlotCanvas = function ResponsiveSwarmPlotCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(SwarmPlotCanvas$1, _extends$2({
      width: width,
      height: height
    }, props));
  });
