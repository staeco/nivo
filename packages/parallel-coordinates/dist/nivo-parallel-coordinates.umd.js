(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('prop-types'), require('@nivo/colors'), require('d3-shape'), require('d3-scale'), require('react-spring'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', 'prop-types', '@nivo/colors', 'd3-shape', 'd3-scale', 'react-spring', '@nivo/tooltip'], factory) :
...
}(this, (function (exports, React, core, axes, PropTypes, colors, d3Shape, d3Scale, reactSpring, tooltip) { 'use strict';
  ...
  var useParallelCoordinates = function useParallelCoordinates(_ref3) {
    var width = _ref3.width,
        ...
        curve = _ref3.curve;
    var getLineColor = colors.useOrdinalColorScale(colors$1, 'index');
  ...
  var ParallelCoordinatesLine = function ParallelCoordinatesLine(_ref) {
    ...
    var animatedPath = core.useAnimatedPath(lineGenerator(points));
  ...
  var WrappedParallelCoordinates = core.withContainer(ParallelCoordinates);
  ...
  var WrappedParallelCoordinatesCanvas = core.withContainer(ParallelCoordinatesCanvas);
