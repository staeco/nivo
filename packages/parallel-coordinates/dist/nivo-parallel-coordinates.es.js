...
import { lineCurvePropType, curveFromProp, useMotionConfig, useAnimatedPath, withContainer, useDimensions, SvgWrapper, ResponsiveWrapper, useTheme } from '@nivo/core';
import { Axis, renderAxisToCanvas } from '@nivo/axes';
import PropTypes from 'prop-types';
import { ordinalColorsPropType, useOrdinalColorScale } from '@nivo/colors';
...
var ParallelCoordinatesLine = function ParallelCoordinatesLine(_ref) {
  ...
  var animatedPath = useAnimatedPath(lineGenerator(points));
