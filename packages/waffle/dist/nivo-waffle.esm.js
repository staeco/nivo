...
import { defsPropTypes, noop, withMotion, bindDefs, withDimensions, withTheme, Container, SvgWrapper, ResponsiveWrapper, getRelativeCursor, isCursorInRect } from '@nivo/core';
...
var ResponsiveWaffle = function ResponsiveWaffle(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(Waffle$1, _extends$1({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveWaffleHtml = function ResponsiveWaffleHtml(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WaffleHtml$1, _extends$2({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveWaffleCanvas = function ResponsiveWaffleCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WaffleCanvas$1, _extends$3({
      width: width,
      height: height
    }, props));
  });
