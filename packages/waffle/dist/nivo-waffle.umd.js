(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash.partial'), require('react-motion'), require('recompose/setDisplayName'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('@nivo/colors'), require('recompose/pure'), require('recompose/compose'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('recompose/withState'), require('lodash.range'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash.partial', 'react-motion', 'recompose/setDisplayName', '@nivo/core', '@nivo/legends', 'prop-types', '@nivo/colors', 'recompose/pure', 'recompose/compose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/withState', 'lodash.range', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.lodash.partial, global.ReactMotion, global.RecomposeSetDisplayName, global.nivo, global.nivo, global.PropTypes, global.nivo, global.RecomposePure, global.RecomposeCompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposeWithState, global.lodash.range, global.nivo));
}(this, (function (exports, React, partial, reactMotion, setDisplayName, core, legends, PropTypes, colors, pure, compose, defaultProps, withPropsOnChange, withState, range, tooltip) { 'use strict';
  ...
  withState = withState && Object.prototype.hasOwnProperty.call(withState, 'default') ? withState['default'] : withState;
