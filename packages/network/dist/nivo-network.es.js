import React, { useState, useEffect, useMemo, memo, useCallback, Fragment, useRef } from 'react';
import { motionPropTypes, useMotionConfig, withContainer, useDimensions, useTheme, SvgWrapper, ResponsiveWrapper } from '@nivo/core';
...
var AnimatedLinks = function AnimatedLinks(_ref2) {
  ...
  return React.createElement(TransitionMotion, {
    ...
    return React.createElement(React.Fragment, null, interpolatedStyles.map(function (_ref3) {
      var key = _ref3.key,
          style = _ref3.style,
          link = _ref3.data;
...
var Network = function Network(props) {
  ...
  var handleNodeHover = useCallback(function (node, event) {
    showTooltipFromEvent(React.createElement(NetworkNodeTooltip$1, {
      node: node,
      tooltip: tooltip
    }), event);
...
var ResponsiveNetwork = function ResponsiveNetwork(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(Network$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveNetworkCanvas = function ResponsiveNetworkCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(NetworkCanvas$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
