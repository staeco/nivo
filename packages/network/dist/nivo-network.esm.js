import React, { useState, useEffect, useMemo, memo, Fragment, useRef } from 'react';
...
var NetworkPropTypes = _objectSpread({}, commonPropTypes, motionPropTypes);
...
var ResponsiveNetwork = function ResponsiveNetwork(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(Network$1, _extends({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveNetworkCanvas = function ResponsiveNetworkCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(NetworkCanvas$1, _extends$1({
      width: width,
      height: height
    }, props));
  });
