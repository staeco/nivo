(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('d3-time-format'), require('@nivo/tooltip'), require('d3-scale'), require('lodash.memoize'), require('lodash.isdate'), require('lodash.range'), require('d3-time')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/legends', 'prop-types', 'd3-time-format', '@nivo/tooltip', 'd3-scale', 'lodash.memoize', 'lodash.isdate', 'lodash.range', 'd3-time'], factory) :
...
}(this, (function (exports, React, core, legends, PropTypes, d3TimeFormat, tooltip, d3Scale, memoize, isDate, range, d3Time) { 'use strict';
